      ...
      <div className="relative hidden lg:flex flex-col justify-between w-1/2 h-full p-12 bg-zinc-950 overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center perspective-[1000px]">
          <motion.div
            ...
            className="relative w-64 aspect-[2/3] rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50 origin-bottom-right -rotate-6 translate-x-12"
          >
            ...
            <div className="absolute bottom-6 left-6 z-20">
              <span className="px-2 py-1 text-[10px] font-bold bg-amber-500/20 text-amber-500 rounded backdrop-blur-md mb-2 inline-block uppercase tracking-wider">
                Aura Original
              </span>
          ...
          <motion.div
            ...
            className="absolute w-56 aspect-[2/3] rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50 origin-bottom-left rotate-6 -translate-x-16 translate-y-12 backdrop-blur-sm bg-black/40"
          >
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10" />
            <img
      ...
      <div className="flex w-full lg:w-1/2 h-full items-center justify-center p-4 sm:p-6 relative bg-zinc-950/50 backdrop-blur-3xl">
        ...
        <div className="w-full max-w-[380px] relative z-10 flex flex-col justify-center">
          ...
          <div className="mb-5 sm:mb-6 text-center lg:text-left">
            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Create your account.</h2>
            <p className="text-xs sm:text-sm text-zinc-400 mt-1.5">Join the network and start streaming.</p>
          </div>
          ...
          <div className="mt-5 sm:mt-6">
            <div className="flex items-center gap-3 mb-4 sm:mb-5">
              ...
              <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">Or register with</span>
              <div className="flex-1 h-px bg-white/5" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isLoading}
                type="button"
                className="flex items-center justify-center gap-2 bg-zinc-900 border border-white/5 hover:bg-zinc-800 rounded-xl py-2.5 transition-colors text-xs sm:text-sm font-semibold text-zinc-300 hover:text-white group disabled:opacity-50"
              >
              ...
              <button
                disabled
                type="button"
                className="flex items-center justify-center gap-2 bg-zinc-900/50 border border-white/5 rounded-xl py-2.5 transition-colors text-xs sm:text-sm font-semibold text-zinc-600 cursor-not-allowed group whitespace-nowrap px-1"
              >
          ...
          <p className="mt-6 text-center text-xs text-zinc-500">
            ...
            <Link href="/auth" className="text-zinc-300 hover:text-white font-semibold transition-colors">
              Sign in
            </Link>
          </p>
